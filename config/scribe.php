...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Obtain a JWT by calling <code>POST /api/v1/auth/login</code> or <code>POST /api/v1/auth/register</code>, then send it as <code>Authorization: Bearer {token}</code>.',
    ],
